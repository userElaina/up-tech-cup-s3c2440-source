...
;;
;;  This code provides basic initialization for an ARM720T including:  
;;  
;;  - creation of a 16KB level 1 page table in physical memory (this will probably 
;;    need to be changed for your target)
;;  - enabling the unified cache and write buffer
;;  - enabling MMU
;;
;;  This code must be run from a privileged mode

        AREA   INIT720, CODE, READONLY      ; name this block of code
...
;
; Note clocking mode of the ARM720T is controlled through external pins (memory mapped in Integrator)
;
