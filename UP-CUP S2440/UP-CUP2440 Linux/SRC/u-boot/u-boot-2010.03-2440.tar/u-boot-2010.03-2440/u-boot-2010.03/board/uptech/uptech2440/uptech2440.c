...
/* arch number of S3C2440-Board */
	gd->bd->bi_arch_number = MACH_TYPE_UPTECH2440 ;
#endif
	...
	icache_enable();
	dcache_enable();
#if	defined(CONFIG_UPTECH2440_LED)
...
#define HSPW_240320_TD		(23)  //64MB nand  is 36 ,128MB is 23
