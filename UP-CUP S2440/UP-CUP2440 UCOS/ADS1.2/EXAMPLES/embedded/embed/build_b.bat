...
REM armcc -c -g -O1 main.c -DEMBEDDED -DUSE_SERIAL_PORT
REM armcc -c -g -O1 retarget.c -DUSE_SERIAL_PORT
armcc -c -g -O1 uart.c -I..\include
armcc -c -g -O1 serial.c -I..\include
armlink vectors.o init.o main.o retarget.o uart.o serial.o stack.o heap.o -scatter scat_b.scf -o embed.axf -entry 0x0 -info totals -info unused
