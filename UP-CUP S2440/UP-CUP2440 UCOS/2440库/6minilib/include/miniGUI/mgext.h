...
/*
 * $Id: mgext.h,v 1.79 2004/01/29 09:52:01 weiym Exp $
 *
...
/** Contains grid general notification information */
typedef struct _GRIDNM_NORMAL
{
    /** wParam parameter of the message */
    WPARAM wParam;
    /** lParam parameter of the message */
...
typedef GRIDNM_NORMAL *PGRIDNM_NORMAL;
                                                                                                                             
/** keydown notification information */
typedef GRIDNM_NORMAL GRIDNM_KEYDOWN;
typedef GRIDNM_KEYDOWN *PGRIDNM_KEYDOWN;
                                                                                                                             
/** Contains listview notification information when mouse down on the header  */
typedef GRIDNM_NORMAL GRIDNM_HEADRDOWN;
typedef GRIDNM_HEADRDOWN *PGRIDNM_HEADRDOWN;
                                                                                                                             
/** Contains listview notification information when mouse up on the header  */
typedef GRIDNM_NORMAL GRIDNM_HEADRUP;
typedef GRIDNM_HEADRUP *PGRIDNM_HEADUP;
                                                                                                                             
/** Contains listview notification information when mouse down on the item area */
typedef GRIDNM_NORMAL GRIDNM_ITEMRDOWN;
typedef GRIDNM_ITEMRDOWN *PGRIDNM_ITEMRDOWN;
                                                                                                                             
/** Contains listview notification information when mouse up on the item area */
typedef GRIDNM_NORMAL GRIDNM_ITEMRUP;
typedef GRIDNM_ITEMRUP *PGRIDNM_ITEMRUP;
 ...
 */
#define GRIDM_GETCOLCOUNT       0xF210

/**
 * \def GRIDM_SETCOLCOUNT
 * \brief Sets the number of all columns in the gird control.
 *
 * An application sends an GRIDM_SETCOLCOUNT message to set the number of all columns in the grid control.
 *
 * \code
 * GRIDM_SETCOLCOUNT
 *
 * wParam = (WPARAM)colnum;
 * lParam = 0;
 * \endcode
 *
 ...
 *
 */
#define GRIDM_SETCOLCOUNT       0xF211

/**
 * \def GRIDM_GETROWCOUNT
 * \brief Gets the number of all rows in the grid control.
 *
 * An application sends an GRIDM_GETROWS message to get the number of all rows in the control.
 *
 * \code
 * GRIDM_GETROWCOUNT
 *
 ...
 */
#define GRIDM_GETROWCOUNT       0xF212

/**
 * \def GRIDM_SETROWCOUNT
 * \brief Set the number of all rows in the grid control.
 *
 * An application sends an GRIDM_SETROWS message to set the number of all rows in the grid control.
 *
 * \code
 * GRIDM_SETROWCOUNT
 * int nRows;
 ...
 * \endcode
 *
 * \param nRows Row number to be set.
 *
 * \return Returns GRID_OKAY if successful, or GRID_ERR otherwise.
 *
 */
#define GRIDM_SETROWCOUNT       0xF213

/**
 * \def GRIDM_ADDCOL
 * \brief Adds a new column to the control.
 * 
 * An application sends a GRIDM_ADDCOL message to add a new column to the control.
 * 
 * \code
 * GRIDM_ADDCOL
 * PGRIDCOLHEADER pColHeader;
 *
 * wParam = 0;
 * lParam = (LPARAM)pColHeader;
 * \endcode
 * 
 * \param pColHeader Struct of column header data, such as column numbers flags ...
 *
 * \return Returns GRID_OKAY if successful, or GRID_ERR otherwise.
 */
 ...
 * An application sends a GRIDM_DELCOL message to delete a specific column.
 *
 * \code
 * GRIDM_DELCOL
 * int nCols
 ...
 * \endcode
 *
 * \param nCols The column to be deleted.
 *
 * \return Returns GRID_OKAY if successful, or GRID_ERR otherwise.
 */
...
/**
 * \def GRIDM_ADDROW
 * \brief Adds a new row to the control.
 *
 * An application sends a GRIDM_ADDROW message to add a new row to the control.
 *
 * \code
 * GRIDM_ADDROW
 * PGRIDROWHEADER pRowHeader;
 *
 * wParam = 0;
 * lParam = (LPARAM)pRowHeader;
 * \endcode
 *
 * \param pRowHeader Struct of row header data, such as row numbers flags ...
 *
 * \return Returns GRID_OKAY if successful, or GRID_ERR otherwise.
 */
 ...
 * \def GRIDM_DELROW
 * \brief Deletes a row.
 * An application sends a GRIDM_DELROW message to delete a specific row.
 *
 * \code
 * GRIDM_DELROW
 * int nRows
 ...
 * \endcode
 *
 * \param nRows The row to be deleted.
 *
 * \return Returns GRID_OKAY if successful, or GRID_ERR otherwise.
 */
...
/**
 * \def GRIDM_SETHEADHEIGHT
 *\brief Sets column header height.
 *
 * an application sends a GRIDM_SETHEADHEIGHT message to set column header height.
 *
 * \code
 * GRIDM_SETHEADHEIGHT
 * int nHeight;
 *
 * wParam = (WPARAM)nHeight;
 * lParam = 0;
 * \endcode
 *
 * \param nHeight Height of header to set.
 *
 * \return Returns GRID_OKAY if successful, or GRID_ERR other.
 */
#define GRIDM_SETHEADHEIGHT     0xF218

/**
 * \def GRIDM_SETHEADWIDTH
 *\brief Sets row header width.
 *
 * an application sends a GRIDM_SETHEADHEIGHT message to set row header width.
 *
 * \code
 * GRIDM_SETHEADWIDTH
 * int nWidth;
 *
 * wParam = (WPARAM)nWidth;
 * lParam = 0;
 * \endcode
 *
 * \param nWidth Width of header to set.
 *
 * \return Returns GRID_OKAY if successful, or GRID_ERR other.
 */
...
/**
 * \def GRIDM_GETHEADWIDTH
 * \brief Gets control's header width.
 *
 * An application sends an GRIDM_GETHEADWIDTH message to get control's header width.
 *
 * \code
 * GRIDM_GETHEADWIDTH
 *
...
/**
 * \def GRIDM_GETHEADHEIGHT
 * \brief Gets control header's height.
 *
 * An application sends an GRIDM_GETHEADHEIGHT message to get control's header height.
 *
 * \code
 * GRIDM_GETROWS
 *
 ...
 * \endcode
 *
 * \return The control's header height.
 */
#define GRIDM_GETHEADHEIGHT     0xF21B

/**
 * \def GRIDM_SETCOLHDR
 * \brief Modifies column header.
 *
 * An application sends a GRIDM_SETCOLHDR message to set column header data such as titile, flags ...
 *
 *\code
 * GRIDM_SETCOLHDR
 * int nCols;
 ...
 * \endcode
 *
 * \param nCols The column to set.
 * \param pColHeader The data structure include titile, flags ...
 *
 * \return Returns GRID_OKAY if successful, or GRID_ERR otherwise.
 */
#define GRIDM_SETCOLHDR        0xF21C

/**
 * \def GRIDM_GETCOLHDR
 * \brief Gets column header data.
 *
 * An application sends a GRIDM_GETCOLDHR message to get column header data such as titile, flags ...
 *
 *\code
 * GRIDM_GETCOLHDR
 * int nCols;
 ...
 * \endcode
 *
 * \param nCols The column to get.
 * \param pColHeader The data structure to hold titile, flags ...
 *
 * \return Returns GRID_OKAY if successful, or GRID_ERR otherwise.
 */
#define GRIDM_GETCOLHDR        0xF21D

/**
 * \def GRIDM_SETROWHDR
 * \brief Sets row header data.
 *
 * An application sends a GRIDM_SETROWHDR message to set row header data such as titile, flags ...
 *
 *\code
 * GRIDM_SETROWHDR
 * int nRows;
 ...
 * \endcode
 *
 * \param nRows The row to set.
 * \param pRowHeader The data structure include titile, flags ...
 *
 * \return Returns GRID_OKAY if successful, or GRID_ERR otherwise.
 */
#define GRIDM_SETROWHDR        0xF21E

/**
 * \def GRIDM_GETROWHDR
 * \brief Gets row header data.
 *
 * An application sends a GRIDM_GETROWHDR message to get row header data such as titile, flags ...
 *
 *\code
 * GRIDM_GETROWHDR
 * int nRows;
 ...
 * \endcode
 *
 * \param nRows The row to get.
 * \param pRowHeader The data structure to hold titile, flags ...
 *
 * \return Returns GRID_OKAY if successful, or GRID_ERR otherwise.
 */
#define GRIDM_GETROWHDR        0xF21F

/**
 * \def GRIDM_SETCOLWIDTH
 * \brief Sets specific column's width.
 *
 * An application sends an GRIDM_SETCOLWIDTH message to set specific column's width.
 *
 * \code
 * GRIDM_SETCOLWIDTH
 * int nCols;
 *
 * wParam = (WPARAM)nCols;
 * lParam = (LPARAM)nWidth;
 * \endcode
 *
 * \param nCols The number of Column to be set.
 * \param nWidth Width in pixel to set.
 *
 * \return Returns GRID_OKAY if successful, or GRID_ERR otherwise.
 *
 */
 ...
 * \brief Get width of column.
 *
 * An application sends an GRIDM_GETCOLWIDTH message to get width of column.
 *
 * \code
 * GRIDM_GETCOLWIDTH
 * int nCols;
 ...
 * 
 *\return Returns width of column, or return -1 otherwise.
 */
#define GRIDM_GETCOLWIDTH       0xF221

/**
 * \def GRIDM_SETROWHEIGHT
 * \brief Set specific row's height.
 *
 * An application sends an GRIDM_SETROWHEIGHT message to set specific row's height.
 *
 * \code
 * GRIDM_SETROWHEIGHT
 *
 * wParam = (WPARAM)nRows;
 * lParam = (LPARAM)nHeight;
 * \endcode
 *
 * \param nRows The row row to be set.
 * \param nWidth Width in pixel to set.
 *
 * \return Returns GRID_OKAY if successful, or GRID_ERR otherwise.
 *
 ...
 * \brief Get height of a row.
 *
 * An application sends an GRIDM_GETROWHEIGHT message to get height of row.
 *
 * \code
 * GRIDM_GETROWHEIGHT
 * int nRows;
 ...
 *
 *\return Returns height of row, or return -1 otherwise.
 */
#define GRIDM_GETROWHEIGHT      0xF223

/**
 * \def GRIDM_SETCELLDATA
 * \brief Set cell data.
 *
 * An application sends a GRIDM_SETCELLDATA message to set cell data such as text, flags ...
 *
 *\code
 * GRIDM_SETCELLDATA
 * PGRIDCELL pCell;
 ...
 * \endcode
 *
 * \param nRows The row number of cell.
 * \param nCols The column number of cell.
 * \param pCell The cell data structure contains information to set.
 *
 * \return Returns GRID_OKAY if successful, or GRID_ERR otherwise.
 */
...
/**
 * \def GRIDM_GETCELLDATA
 * \brief Gets cell data.
 *
 * An application sends a GRIDM_GETCELLDATA message to get cell data such as text, flags ...
 *
 *\code
 * GRIDM_GETCELLDATA
 * PGRIDCELL pCell;
 ...
 * \endcode
 *
 * \param pCell The structure to hold cell data.
 *
 * \return Returns GRID_OKAY if successful, or GRID_ERR otherwise.
 */
...
/**
 * \def GRIDM_GETFOCUSCELL
 * \brief Gets the focus cell data.
 *
 * An application sends a GRIDM_GETCELLDATA message to get the focus cell data such as text, flags ...
 *
 *\code
 * GRIDM_GETFOCUSCELL
 * PGRIDCELL pCell;
 ...
 * \return Returns GRID_OKAY if successful, or GRID_ERR otherwise.
 */
#define GRIDM_GETFOCUSCELL	0xF226

/**
 * \def GRIDM_GETCELLTEXTLEN
 * \brief Gets text length of cell.
 * 
 * An application sends a GRIDM_GETCELLTEXTLEN message to get text length of the cell.
 * 
 * \code 
 * GRIDM_GETCELLTEXTLEN
 * PGRIDCELL pCell;
 *
 * wParam = 0;
 * lParam = (LPARAM)pCell;
 * \endcode
 *
 * \param pCell The sturcture hold cell data.
 *
 * \return Returns text length of the cell.
 */
#define GRIDM_GETCELLTEXTLEN 	0xF227

/**
 * \def GRIDM_GETCELLTEXT
 * \brief Gets text of cell.
 * 
 * An application sends a GRIDM_GETCELLTEXT message to get text of the cell.
 * 
 * \code 
 * GRIDM_GETCELLTEXT
 * PGRIDCELL pCell;
 ...
 * \param pCell The sturcture hold cell data.
 *
 * \return Returns text of the cell.
 */
#define GRIDM_GETCELLTEXT	0xF228

/**
 * \def GRIDM_SETCELLFOCUS
 * \brief Set the focus cell.
 *
 * An application send GRIDM_SETCELLFOCUS to set the focus cell.
 *
 * \code
 * GRIDM_SETCELLFOCUS
 * int nCols;
 ...
 * \return Returns GRID_OKAY if successful, or GRID_ERR otherwise.
 */
#define GRIDM_SETCELLFOCUS      0xF229

/**
 * \def GRIDM_SETCELLEDIT
 * \brief Set the edit cell.
 *
 * An application send GRIDM_SETCELLFOCUS to set the edit cell.
 *
 * \code
 * GRIDM_SETCELLEDIT
 * int nCols;
 ...
 * \return Returns GRID_OKAY if successful, or GRID_ERR otherwise.
 */
#define GRIDM_SETCELLEDIT       0xF22A //reserved, not implement
 ...
 *        on the grid header.
 */
#define GRIDN_HEADRUP            7

/**
 * \def GRIDN_KEYDOWN
 * \brief This notification code informs parent window that a key has been pressed.
 */
#define GRIDN_KEYDOWN            8

/**
 *
 * \def GRIDN_CELLDBCLK
 * \brief This notification code informs parent window the current selected cell 
 *        has be double clicked.
 */
#define GRIDN_CELLDBCLK          9
 ...
 *        has been clicked.
 */
#define GRIDN_CELLCLK            10

/**
 * \def GRIDN_FOCUSCHANGE
 * \brief This notification code informs parent window the current selected item 
 *        has changed.
 */
#define GRIDN_FOCUSCHANGE          11
 ...
 *        has changed.
 */
#define GRIDN_COLCHANGE          12

/**
 * \def GRIDN_CELLTEXTCHANGE
 * \brief This notification code informs parent window the cell text
 *        has changed.
 */
#define GRIDN_CELLTEXTCHANGE          13
