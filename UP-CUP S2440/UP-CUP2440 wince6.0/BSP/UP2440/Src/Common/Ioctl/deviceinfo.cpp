...
BOOL OALIoCtlHalGetDeviceInfo( 
    ...
    OALMSG(1, (L"+OALIoCtlHalGetDeviceInfo(...)\r\n"));
...
static BOOL GetUUID(
    ...
    if(rc = (CheckBufferSize(pOutBuffer, outSize, pOutSize, sizeof(GUID), *spiName)))
    {
        GUID *pUuid;
