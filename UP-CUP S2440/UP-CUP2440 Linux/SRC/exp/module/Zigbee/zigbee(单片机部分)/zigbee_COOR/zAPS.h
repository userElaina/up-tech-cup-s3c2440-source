...
#define APSGetDestShortAddr() NWKGetDestShortAddr()

//add by lyj_uptech@126.com
#define APSGetSrcShortAddr() NWKGetSrcShortAddr()
//add by lyj_uptech@126.com
#define APSGetLongAddress(x) NWKGetLongAddress(x)
//add by lyj_uptech@126.com
#define APSGetShortAddress(x) NWKGetShortAddress(x)
/*********************************************************************
