...
#define rRTCCON					bRTC(0x40)
#define rBCDSEC					bRTC(0x70)
#define rBCDMIN					bRTC(0x74)
#define rBCDHOUR				bRTC(0x78)
#define rBCDDATE				bRTC(0x7C)
#define rBCDDAY					bRTC(0x80)
#define rBCDMON					bRTC(0x84)
#define rBCDYEAR				bRTC(0x88)
